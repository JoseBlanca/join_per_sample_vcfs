...
//! [`PerPositionMerger`](crate::var_calling_new::per_position_merger::PerPositionMerger)
//! (or any
...
#[cfg(test)]
use crate::var_calling_new::per_position_merger::PerPositionMergerError;
use crate::var_calling_new::per_position_merger::PerPositionPileups;
...
/// configs ([`crate::var_calling_new::posterior_engine::PosteriorEngineConfig`],
...
///
/// [`PosteriorEngineConfig::contamination`]: crate::var_calling_new::posterior_engine::PosteriorEngineConfig::contamination
#[derive(Debug, Clone, PartialEq)]
#[non_exhaustive]
...
pub enum ContaminationEstimationError {
    ...
    /// [`PerPositionMergerError`](crate::var_calling_new::per_position_merger::PerPositionMergerError)
    /// or the
    /// chunk-driven
...
/// [`crate::var_calling_new::posterior_engine`] — the floor/ceiling are
...
///
/// Shared with the Stage 6 mixture-likelihood E-step at
/// [`crate::var_calling_new::posterior_engine`].
