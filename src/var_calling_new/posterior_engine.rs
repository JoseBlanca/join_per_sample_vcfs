...
//! by the side-pass at
//! [`crate::var_calling_new::contamination_estimation`]; `None` runs the
...
use crate::var_calling_new::contamination_estimation::{
...
pub struct PosteriorEngineConfig {
    ...
    /// cohort CLI review).
    ///
    /// [`estimate_contamination`]: crate::var_calling_new::contamination_estimation::estimate_contamination
...
//   [`crate::var_calling_new::worker`] — wraps
...
mod tests {
    use super::*;
    use crate::var_calling_new::per_group_merger::MergedAllele;
    ...
    fn build_accuracy_battery<M: MathBackend + Copy>(approx: M) -> AccuracyReport {
        ...
        contam_cfg.contamination = Some(
            crate::var_calling_new::contamination_estimation::ContaminationEstimates::from_user_supplied(
