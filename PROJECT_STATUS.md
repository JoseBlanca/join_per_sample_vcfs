...
>
> - **Last completed task (2026-07-19):** **ng reference_info — MILESTONE A COMPLETE (types + the cheap `.fai` reader), at Checkpoint A.** Plan-driven (A1–A4), one implement→review→apply→commit loop per step. Impl report: [ng_reference_info_milestone_a_2026-07-19](doc/devel/reports/implementations/ng_reference_info_milestone_a_2026-07-19.md). New module [`src/ng/reference_info.rs`](src/ng/reference_info.rs).
