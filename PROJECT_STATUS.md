...
>
> - **Last completed task (2026-07-19):** **ng reference_info — MILESTONE B COMPLETE (the FASTA streaming pass — the heart), at Checkpoint B.** Plan-driven (B1+B2 one commit, B3 its own), same implement→review→apply→commit loop. Impl report: [ng_reference_info_milestone_b_2026-07-19](doc/devel/reports/implementations/ng_reference_info_milestone_b_2026-07-19.md).
