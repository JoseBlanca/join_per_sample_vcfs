...
>   **Next:** answer review Q1 (is Stage-1 `.ssr.psp` output sparse?); build the SSR cohort bench that gates Mi3/Mi4; then real-data calibration of the provisional `dev_default` constants — and the first real cohort SSR call.
