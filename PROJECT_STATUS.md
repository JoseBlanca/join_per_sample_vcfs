...
>
> - **Last completed task (2026-07-16):** **ng step 3 typed regions — Milestone C complete + D1/D2 (the walk exists and reproduces the golden catalog). ⛔ D3 BLOCKED, needs a decision.**
...
>   1856 lib tests; fmt/clippy clean; **nothing outside `src/ng/`**. **Next:** decide D3's byte-source question, then D3 (the three carries, window-invariance vs D1, and discharging the `contig_len` provenance obligation), then Checkpoint D.
