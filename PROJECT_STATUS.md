...
>
> - **Last completed task (2026-07-19):** **ng reference_info — MODULE COMPLETE (Milestones D & E), at Checkpoint E.** Plan-driven, one implement→review→apply→commit loop per step; the whole reader (`src/ng/reference_info.rs`, 52 tests) is now built. Impl report: [ng_reference_info_milestone_de_2026-07-19](doc/devel/reports/implementations/ng_reference_info_milestone_de_2026-07-19.md).
