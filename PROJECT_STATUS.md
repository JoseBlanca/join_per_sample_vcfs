...
- **Status:** in-flight (branch `tomato2-paralog-filter`; A1 + B1 + B2 + B3 + C1+C2 reviewed + fixes-applied; pileup now emits the summary section end-to-end. Remaining: D2 empirical parity + D3 cost check, both needing real tomato2 data)
