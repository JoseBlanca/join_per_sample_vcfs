...
def test_simple_insertion():
    ...
    expected = {
        ...
        "pos": 10,
        "ref_allele": "AG",
        "alt_alleles": {"AC", "ATTC", "TT", "AT"},
        "genotypes": [["AC", "ATTC"], ["AT", "TT"]],
        "samples": ["sample1", "sample2"],
        "phases": [False, False],
    }
    check_expected_result(result, expected)
...
def test_overlapping_deletions():
    ...
    expected = {
        ...
        "pos": 10,
        "ref_allele": "ATT",
        "alt_alleles": {"AT", "AC", "GT"},
        "genotypes": [["AT", "AC"], ["GT", "GT"]],
        "samples": ["sample1", "sample2"],
        "phases": [False, False],
    }
    check_expected_result(result, expected)
...
def test_two_deletions_in_same_sample():
    var1_sample1 = {
        "chrom": 1,
        "pos": 10,
        "alleles": ["ATG", "A", "AG"],
    ...
    expected = {
        ...
        "pos": 10,
        "ref_allele": "ATG",
        "alt_alleles": {"A", "AG", "GTG", "GT"},
        "genotypes": [["A", "AG"], ["GTG", "GT"]],
        "samples": ["sample1", "sample2"],
        "phases": [False, False],
    }
    check_expected_result(result, expected)
