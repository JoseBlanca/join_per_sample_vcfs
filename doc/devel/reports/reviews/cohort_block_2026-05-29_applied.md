...
| M32 | Major    | `locate_sample_row_idx` linear-scan invariant not pinned | Apply | — | No | — | — | — |
| Mi1 | Minor    | New pub data structs lack `#[non_exhaustive]` | Ask | — | Yes (Q1) | — | — | — |
...
| Mi9 | Minor    | `Arc::new(StreamingChromRefFetcher)` single-owner | Apply | — | No | — | — | — |
| Mi10 | Minor   | `chunk.windows.clone()` defensive | Apply | — | No | — | — | — |
